...
individuals22 <- op22 %>% 
  ...
  mutate(color = case_when(
    year == "2022" ~ "blue", #assign 2022-marked salamanders a color (even though they don't have VIE tags, this will help with the code and data QAQC)
    .default = color
  )) %>% 
