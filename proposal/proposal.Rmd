...
Data collection for this project is done in partnership with Acadia National Park and our research methods have gone through IACUC (Institutional Animal Care and Use Committee) review and approval. 
...
Below are a few of the questions that I am most interested in answering through this project:

* Which pools are most frequently visited across all seasons? (confirm Steve's assumption)
* Rate of salamander returns using VIE color tags for year cohorts (n = 9 seasons): What is the proportion of returning salamanders to new recruits each season?
...
* What is the most efficient way to collect these data in the field? (Prepare streamlined datasheet for data collection in future seasons)
